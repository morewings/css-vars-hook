...
|  [RootThemeProvider](./css-vars-hook.rootthemeprovider.md) | Root theme context provider also creates div to contain CSS properties. <code>ThemeType</code> is declared globally. |
